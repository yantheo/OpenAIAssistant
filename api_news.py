...
def get_news(topic):
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            # Access all the fields == loop throught
            status = data["status"]
            ...
            for article in articles:
                ...
                title_description = f"""
                  ...
                  URL: {url}
                """
                all_news.append(title_description)
    ...
    def call_required_functions(self, required_actions):
        ...
        for action in required_actions["tool_calls"]:
            ...
            if func_name == "get_news":
                ...
                raise ValueError(f"Unknow function: {func_name}")
    ...
    with st.form(key="user_input_form"):
        ...
        if submit_button:
            manager.create_assistant(
                ...
                instructions="You are personal article summerizer assistant who knows how to take a list of article's titles and descriptions and then write a short summary of all the news articles",
                tools=[
                    {
                        "type": "function",
                        "function": {
                            "name": "get_news",
                            "description": "Get the list of articles/news for the given",
                            "parameters": {
                                "type": "object",
                                "properties": {
                                    "topic": {
                                        "type": "string",
                                        "description": "The topics for the news"
                                    }
                                },
                                "required": ["topic"],
                            },
